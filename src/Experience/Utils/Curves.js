...
export default class Curves {
  ...
  */
  ...
  static CenterToCoding = {
    ...
    line: [
      new Vector3(-1.23, 0.21, 0.68),
      new Vector3(-5.85, 0.21, 1.1),
      new Vector3(-5.67, 0.6, -0.34),
      new Vector3(-5.43, 0.6, -0.43),
      new Vector3(-5.43, 0.6, -0.6),
      new Vector3(-5.69, 0.55, -0.6),
    ],
  };
  ...
  static CenterToHVAC = {
    ...
    line: [
      new Vector3(-1.23, 0.21, 0.68),
      new Vector3(-6.03, 0.21, 0.68),
      new Vector3(-7.09, 0.21, -0.33),
      new Vector3(-6.57, 0.21, -0.92),
      new Vector3(-6.52, 0.21, -1.18),
      new Vector3(-5.63, 0.21, -1.17),
      new Vector3(-5.43, 0.21, -1.05),
      new Vector3(-3.14, 0.21, -0.83),
      new Vector3(-1.8, 0.21, -0.75),
      new Vector3(-1.82, 0.21, -1.55),
      new Vector3(-1.35, 0.21, -1.63),
    ],
  };
  static HVACToCenter = {
    move: new Vector3(-3.95, 8.43, 2.83),
  ...
  static CenterToConstruction = {
    ...
    line: [
      ...
      new Vector3(-5.43, 0.21, -1.05),
      new Vector3(-3.14, 0.21, -0.83),
      new Vector3(-2.03, 0.21, -0.75),
      new Vector3(-2.09, 0.21, -1.31),
      new Vector3(-2.26, 0.21, -1.53),
    ],
  };
  static CenterToElectrical = {
    ...
    line: [
      ...
      new Vector3(-5.63, 0.21, -1.17),
      new Vector3(-5.43, 0.21, -1.05),
      new Vector3(-4.07, 0.21, -0.88),
      new Vector3(-4.12, 0.21, -1.46),
    ],
  };
  static CenterToDiesel = {
    ...
    line: [
      ...
      new Vector3(-5.63, 0.21, -1.17),
      new Vector3(-5.43, 0.21, -1.05),
      new Vector3(-3.66, 0.21, -0.88),
      new Vector3(-3.62, 0.21, -0.26),
    ],
  };
  static CenterToPharmacy = {
    ...
    line: [
      ...
      new Vector3(-6.57, 0.21, -0.92),
      new Vector3(-6.52, 0.21, -1.18),
      new Vector3(-6.11, 0.21, -1.23),
      new Vector3(-5.99, 0.21, -1.86),
      new Vector3(-5.94, 0.21, -1.94),
    ],
  };
  static CenterToAuto = {
